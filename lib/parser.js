module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c77 = function(when, otherwise) {
            return {
              type: 'if',
              when: when,
              otherwise: otherwise
        ...
        peg$c78 = { type: "other", description: "when" },
        peg$c79 = "<when",
        peg$c80 = { type: "literal", value: "<when", description: "\"<when\"" },
        peg$c81 = "expr",
        ...
        peg$c86 = { type: "other", description: "otherwise" },
        peg$c87 = "<otherwise>",
        peg$c88 = { type: "literal", value: "<otherwise>", description: "\"<otherwise>\"" },
        peg$c89 = "</otherwise>",
        peg$c90 = { type: "literal", value: "</otherwise>", description: "\"</otherwise>\"" },
        peg$c91 = function(nodes) {
            return {
              type: 'otherwise',
              nodes: nodes
            }
          },
        peg$c92 = { type: "other", description: "case" },
        peg$c93 = "<case:",
        peg$c94 = { type: "literal", value: "<case:", description: "\"<case:\"" },
        peg$c95 = "</case:",
        peg$c96 = { type: "literal", value: "</case:", description: "\"</case:\"" },
        peg$c97 = function(name, expr, when, otherwise, _name) { return name == _name },
        peg$c98 = function(name, expr, when, otherwise, _name) {
            return {
              type: 'case',
              name: name,
              expr: expr,
        ...
        peg$c99 = { type: "other", description: "each" },
        peg$c100 = "<each:",
        peg$c101 = { type: "literal", value: "<each:", description: "\"<each:\"" },
        peg$c102 = "in",
        peg$c103 = { type: "literal", value: "in", description: "\"in\"" },
        peg$c104 = "</each:",
        peg$c105 = { type: "literal", value: "</each:", description: "\"</each:\"" },
        peg$c106 = function(name, expr, nodes, _name) { return name == _name },
        peg$c107 = function(name, expr, nodes, _name) {
            return {
              type: 'each',
              name: name,
              expr: expr,
        ...
        peg$c108 = { type: "other", description: "plain text" },
        peg$c109 = /^[^<#!$]/,
        peg$c110 = { type: "class", value: "[^<#!$]", description: "[^<#!$]" },
        peg$c111 = "/",
        peg$c112 = { type: "literal", value: "/", description: "\"/\"" },
        peg$c113 = "include",
        peg$c114 = { type: "literal", value: "include", description: "\"include\"" },
        peg$c115 = "inline",
        peg$c116 = { type: "literal", value: "inline", description: "\"inline\"" },
        peg$c117 = "block",
        peg$c118 = { type: "literal", value: "block", description: "\"block\"" },
        peg$c119 = "if",
        peg$c120 = { type: "literal", value: "if", description: "\"if\"" },
        peg$c121 = "case",
        peg$c122 = { type: "literal", value: "case", description: "\"case\"" },
        peg$c123 = "when",
        peg$c124 = { type: "literal", value: "when", description: "\"when\"" },
        peg$c125 = "otherwise",
        peg$c126 = { type: "literal", value: "otherwise", description: "\"otherwise\"" },
        peg$c127 = "each",
        peg$c128 = { type: "literal", value: "each", description: "\"each\"" },
        peg$c129 = "var",
        peg$c130 = { type: "literal", value: "var", description: "\"var\"" },
        peg$c131 = /^[#!$]/,
        peg$c132 = { type: "class", value: "[#!$]", description: "[#!$]" },
        peg$c133 = { type: "other", description: "variable name" },
        peg$c134 = /^[a-z]/,
        peg$c135 = { type: "class", value: "[a-z]", description: "[a-z]" },
        peg$c136 = /^[a-zA-Z0-9_]/,
        peg$c137 = { type: "class", value: "[a-zA-Z0-9_]", description: "[a-zA-Z0-9_]" },
        peg$c138 = { type: "other", description: "attribute value" },
        peg$c139 = { type: "other", description: "string" },
        peg$c140 = "'",
        peg$c141 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c142 = /^[^']/,
        peg$c143 = { type: "class", value: "[^']", description: "[^']" },
        peg$c144 = function(chars) { return chars },
        peg$c145 = "\"",
